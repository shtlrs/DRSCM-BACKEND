...
class HourlyTravelViewTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.super_hourly_travel = create_random_hourly_travel(project=cls.super_project, save=False)
        ...
        cls.user_hourly_travel = create_random_hourly_travel(project=cls.user_project, save=False)
