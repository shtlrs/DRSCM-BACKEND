...
@extend_schema_view(
     get=extend_schema(description='Returns the list of the projects available for the user',
                       operation_id="List projects"),
     post=extend_schema(description='Creates a new project for the user', operation_id="Create project"),
 )
...
@extend_schema_view(
    get=extend_schema(description='Returns the details of a particular project', operation_id="Get project"),
    delete=extend_schema(description='Deletes a particular project', operation_id="Delete project"),
    put=extend_schema(description='Updates a project fully', operation_id="Update project"),
    patch=extend_schema(description='Patches a project by doing a partial update of specific fields',
