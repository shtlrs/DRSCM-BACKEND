...
from utils.date import get_current_timestamp_with_null_seconds, timestamp_to_date
...
class WorkSession(models.Model):
    ...
    def __str__(self):
        return f"Session: {timestamp_to_date(self.start_timestamp)} -> {timestamp_to_date(self.end_timestamp)}"
